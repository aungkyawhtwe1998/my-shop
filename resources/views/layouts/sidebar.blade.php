<div class="col-12 col-lg-3 col-xl-2 vh-100 sidebar">
    ...
    <div class="nav-menu">
        <ul>
            ...
            <x-menu-item name="Manage Categories" class="fas fa-plus-circle"
            ...
            <x-menu-item name="Update User Info" class="fas fa-envelope" link="{{ route('profile.edit.user.info') }}">
            </x-menu-item>
            <x-menu-item name="Update photo" class="fas fa-image" link="{{ route('profile.edit.photo') }}">
            </x-menu-item>

            <x-menu-title name="Quit"></x-menu-title>
