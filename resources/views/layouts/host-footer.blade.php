<div class="container-fluid">
    <div class="row mt-5 pt-3 align-items-center justify-content-center">
        <div class="col-12 text-center">
            <h2 class="text-primary  wow bounce">Contact or suggest me</h2>
        </div>
        ...
        <div class="col-12 col-lg-6 wow slideInLeft ani-delay-1">
            <form action="{{ route('message.store') }}" method="POST"
                ...
                <div class="form-group mb-3">
                    <input type="text" name="name" class="form-control my-input" placeholder="Enter your name">
                    @error('name')
                        <small class="font-weight-bold text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="form-group mb-3">
                    <input type="email" name="email" class="form-control  my-input" placeholder="Enter your Email">
                    @error('email')
                        <small class="font-weight-bold text-danger">{{ $message }}</small>
                ...
                <button class="btn btn-outline-primary btn-message border-3 text-light fw-bolder">Send
                    Message</button>
